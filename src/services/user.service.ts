...
export const userService = {
     ...
     * ```
     */
    async getAll(params?: SearchParams): Promise<ApiResponse<PaginatedResponse<User>>> {
     ...
     */
    async update(id: string | number, data: UpdateUserData): Promise<ApiResponse<User>> {
     ...
     * @returns Updated user
     */
    async patch(id: string | number, data: Partial<UpdateUserData>): Promise<ApiResponse<User>> {
     ...
     * ```
     */
    async uploadAvatar(id: string | number, formData: FormData): Promise<ApiResponse<User>> {
